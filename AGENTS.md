...
| `ordersim/replay/factory.py` | Builds feed, venue, OMS, portfolio | Mostly internal |
| `ordersim/sim/matching_engine.py` | MBO matching and queue tracking | Internal |
| `ordersim/sim/feed.py` | Event replay cursor | Internal |
...
class OrderGateway(Protocol):
    def place_limit(self, side: str, price, size: int, tif: str = "GTC"): ...
